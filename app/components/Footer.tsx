      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:px-4 md:px-6 sm:py-4 md:py-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          <div className="flex flex-col gap-2 min-w-0">
            <span className="text-xs uppercase tracking-wider text-text-muted font-bold">Contact</span>
            <a
            ...
            <span className="text-sm text-text-muted font-medium">© 2026 — Mikhael Baytelman</span>
          </div>
