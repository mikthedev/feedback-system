...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full mt-auto bg-background pb-[env(safe-area-inset-bottom)]">
      <div className="max-w-6xl mx-auto px-3 py-2 sm:px-4 md:px-6 sm:py-3">
        <div className="rounded-xl border border-gray-700/50 bg-background-light/30 p-2.5 sm:p-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex min-w-0 flex-col gap-1.5">
              ...
              <span className="text-xs sm:text-sm text-text-muted font-medium">{t('footer.copyright')}</span>
            </div>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-2.5 flex-shrink-0 w-full lg:w-auto">
            <div className="grid sm:hidden grid-cols-2 items-stretch gap-2">
              <Link
                href="/terms"
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 min-h-[40px] pl-3 pr-3 sm:pl-3.5 sm:pr-3.5 rounded-xl border-2 bg-background-lighter touch-manipulation w-full sm:w-auto transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                  dropdownOpen
